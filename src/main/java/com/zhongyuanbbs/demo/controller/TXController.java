...
public class TXController {
    ...
    static COSCredentials cred = new BasicCOSCredentials("AKIDZt5LI5eZO0KNVblUpte7YwgIfJhNqa8Q", "6vbb7LH3wqTo8EM5WnxB7lAInWrBdohN");
    ...
    static String bucketName = "file-1301851351";
    // 指定要上传到 COS 上对象键
    ...
    public static String upload(){
        ...
        File localFile = new File("C:\\Users\\DELL\\Pictures\\Saved Pictures\\5191.jpg");
        PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, key, localFile);
        PutObjectResult putObjectResult = cosClient.putObject(putObjectRequest);
        String etag = putObjectResult.getETag();  // 获取文件的 etag
        String dateStr = putObjectResult.getDateStr();
        return dateStr;
    }
